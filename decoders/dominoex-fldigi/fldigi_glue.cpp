...
struct ModeInfoBootstrap {
  ModeInfoBootstrap() {
    ...
    auto fill = [](int idx, const char* s, const char* n) {
      ...
      mode_info[idx].adif_name      = "DOMINOEX";
      mode_info[idx].pskmail_name   = s;
      mode_info[idx].export_mode    = "DOMINOEX";
      mode_info[idx].export_submode = s;
      mode_info[idx].vid_name       = s;
    };
    fill(MODE_DOMINOEX4,  "DominoEX4",  "DominoEX-4");
    fill(MODE_DOMINOEX5,  "DominoEX5",  "DominoEX-5");
    fill(MODE_DOMINOEX8,  "DominoEX8",  "DominoEX-8");
    fill(MODE_DOMINOEX11, "DominoEX11", "DominoEX-11");
    fill(MODE_DOMINOEX16, "DominoEX16", "DominoEX-16");
    fill(MODE_DOMINOEX22, "DominoEX22", "DominoEX-22");
    fill(MODE_DOMINOEX44, "DominoEX44", "DominoEX-44");
    fill(MODE_DOMINOEX88, "DominoEX88", "DominoEX-88");
  }
