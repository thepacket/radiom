...
// TX-gen mode: when active, fldigi's modem TX path drives ModulateXmtr with
// PCM samples; we forward them to stdout as int16 LE so a host script can
// pipe them into sox/ffmpeg. RX builds leave g_tx_gen_active=false and the
// function is a no-op.
...
// TX-gen text buffer: main.cpp seeds this with the message to send. When the
// modem calls get_tx_char() it pulls one byte at a time; once exhausted we
// return ETX so tx_process() flushes its postamble and returns -1.
...
struct ModeInfoBootstrap {
  ModeInfoBootstrap() {
    ...
    fill(MODE_PSK31,    "BPSK31",   "BPSK-31");
    fill(MODE_PSK63,    "BPSK63",   "BPSK-63");
    fill(MODE_PSK63F,   "BPSK63F",  "BPSK-63F");
    fill(MODE_PSK125,   "BPSK125",  "BPSK-125");
    fill(MODE_PSK250,   "BPSK250",  "BPSK-250");
    fill(MODE_PSK500,   "BPSK500",  "BPSK-500");
    fill(MODE_PSK1000,  "BPSK1000", "BPSK-1000");
    fill(MODE_QPSK31,   "QPSK31",   "QPSK-31");
    fill(MODE_QPSK63,   "QPSK63",   "QPSK-63");
    fill(MODE_QPSK125,  "QPSK125",  "QPSK-125");
    fill(MODE_QPSK250,  "QPSK250",  "QPSK-250");
    fill(MODE_QPSK500,  "QPSK500",  "QPSK-500");
    fill(MODE_8PSK125,    "8PSK125",    "8PSK-125");
    fill(MODE_8PSK125FL,  "8PSK125FL",  "8PSK-125FL");
    fill(MODE_8PSK125F,   "8PSK125F",   "8PSK-125F");
    fill(MODE_8PSK250,    "8PSK250",    "8PSK-250");
    fill(MODE_8PSK250FL,  "8PSK250FL",  "8PSK-250FL");
    fill(MODE_8PSK250F,   "8PSK250F",   "8PSK-250F");
    fill(MODE_8PSK500,    "8PSK500",    "8PSK-500");
    fill(MODE_8PSK500F,   "8PSK500F",   "8PSK-500F");
    fill(MODE_8PSK1000,   "8PSK1000",   "8PSK-1000");
    fill(MODE_8PSK1000F,  "8PSK1000F",  "8PSK-1000F");
    fill(MODE_8PSK1200F,  "8PSK1200F",  "8PSK-1200F");
    fill(MODE_PSK125R,  "PSK125R",  "PSK-125R");
    fill(MODE_PSK250R,  "PSK250R",  "PSK-250R");
    fill(MODE_PSK500R,  "PSK500R",  "PSK-500R");
    fill(MODE_PSK1000R, "PSK1000R", "PSK-1000R");
  }
