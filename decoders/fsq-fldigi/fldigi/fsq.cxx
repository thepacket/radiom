...
// ── RX-only stubs ────────────────────────────────────────────────────
// Everything below was the TX path + GUI-driven helpers. Gutted so the
// receiver builds without dragging in fldigi's GUI/timer/queue stack.

void fsq::send_tone(int)             {}
void fsq::send_symbol(int)           {}
void fsq::send_idle()                {}
void fsq::send_char(int)             {}
void fsq::send_image()               {}
void fsq::send_string(std::string)   {}
void fsq::fsq_send_image(std::string){}
int  fsq::tx_process()               { return -1; }
...
// Free functions referenced by parse_* code paths.
double fsq_xmtdelay()                { return 0.0; }
void   fsq_repeat_last_command()     {}
void   fsq_xmt(std::string)          {}
void   fsq_xmt_mt(void* = nullptr)   {}
void   fsq_transmit(void* = nullptr) {}
void   fsq_add_tx_timeout(void* = nullptr) {}
void   fsq_start_aging(void*)        {}
