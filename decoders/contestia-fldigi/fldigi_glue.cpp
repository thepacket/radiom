...
struct ModeInfoBootstrap {
  ModeInfoBootstrap() {
    ...
    auto fill = [](int idx, const char* s) {
      mode_info[idx].sname          = s;
      mode_info[idx].name           = s;
      mode_info[idx].adif_name      = "CONTESTI";
      mode_info[idx].pskmail_name   = s;
      mode_info[idx].export_mode    = "CONTESTI";
      mode_info[idx].export_submode = s;
      mode_info[idx].vid_name       = s;
    };
    fill(MODE_CONTESTIA,         "CONTESTIA");
    fill(MODE_CONTESTIA_4_125,   "CON-4-125");
    fill(MODE_CONTESTIA_4_250,   "CON-4-250");
    fill(MODE_CONTESTIA_4_500,   "CON-4-500");
    fill(MODE_CONTESTIA_4_1000,  "CON-4-1K");
    fill(MODE_CONTESTIA_4_2000,  "CON-4-2K");
    fill(MODE_CONTESTIA_8_125,   "CON-8-125");
    fill(MODE_CONTESTIA_8_250,   "CON-8-250");
    fill(MODE_CONTESTIA_8_500,   "CON-8-500");
    fill(MODE_CONTESTIA_8_1000,  "CON-8-1K");
    fill(MODE_CONTESTIA_8_2000,  "CON-8-2K");
    fill(MODE_CONTESTIA_16_250,  "CON-16-250");
    fill(MODE_CONTESTIA_16_500,  "CON-16-500");
    fill(MODE_CONTESTIA_16_1000, "CON-16-1K");
    fill(MODE_CONTESTIA_16_2000, "CON-16-2K");
    fill(MODE_CONTESTIA_32_1000, "CON-32-1K");
    fill(MODE_CONTESTIA_32_2000, "CON-32-2K");
    fill(MODE_CONTESTIA_64_500,  "CON-64-500");
    fill(MODE_CONTESTIA_64_1000, "CON-64-1K");
    fill(MODE_CONTESTIA_64_2000, "CON-64-2K");
  }
