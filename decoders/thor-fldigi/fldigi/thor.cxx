...
// ── RX-only stubs ────────────────────────────────────────────────────
// Everything below was the TX path + image transmission. Gutted so the
// receiver builds without the GUI/keyer stack.

int          thor::IMAGEspp     = 8;
std::string  thor::imageheader  = "";
std::string  thor::avatarheader = "";
void thor::thor_send_image(std::string, bool) {}
void thor::thor_send_avatar()                 {}
void thor::m_thor_send_avatar()               {}

int  thor::get_secondary_char()              { return 0; }
void thor::sendtone(int, int)                {}
void thor::sendsymbol(int)                   {}
void thor::sendchar(unsigned char, int)      {}
void thor::sendidle()                        {}
void thor::sendsecondary()                   {}
void thor::Clearbits()                       {}
void thor::flushtx()                         {}
int  thor::tx_process()                      { return -1; }
