...
void activate_thor_image_item(bool)                 {}
void thor_clear_avatar()                            {}
void thor_showRxViewer(const char*)                 {}
void thor_update_avatar(unsigned char, int)         {}
void thor_updateRxPic(unsigned char, int)           {}
...
struct ModeInfoBootstrap {
  ModeInfoBootstrap() {
    ...
    auto fill = [](int idx, const char* s, const char* n) {
      ...
      mode_info[idx].adif_name      = "PSK";
      mode_info[idx].pskmail_name   = s;
      mode_info[idx].export_mode    = "PSK";
      mode_info[idx].export_submode = s;
      mode_info[idx].vid_name       = s;
    };
    fill(MODE_THOR4, "THOR4", "THOR-4");
    fill(MODE_THOR5,    "THOR5",    "THOR-5");
    fill(MODE_THOR8,    "THOR8",    "THOR-8");
    fill(MODE_THOR11,   "THOR11",   "THOR-11");
    fill(MODE_THOR16,   "THOR16",   "THOR-16");
    fill(MODE_THOR22,   "THOR22",   "THOR-22");
    fill(MODE_THOR25x4, "THOR25x4", "THOR-25x4");
    fill(MODE_THOR50x1, "THOR50x1", "THOR-50x1");
    fill(MODE_THOR50x2, "THOR50x2", "THOR-50x2");
    fill(MODE_THOR100,  "THOR100",  "THOR-100");
  }
